...
class NBC:
	...
	def __init__(self, training_data_fname):
		...
		"""
		self.data = parser.create_data(training_data_fname)
	...
	def training(self, data):
		...
		"""
		self.trained_data = NBC_trainer.train(data)
		pass

	def testing(self, trained_data):
		"""
		...
		"""
		self.answers = NBC_tester.test(trained_data)
		pass
